  ...
  <div class="animateMap">
    <div class="view">
      ...
      <div v-for="item in 4" :key="'circle'+item" :class="'circle'+item"
           :style="{backgroundImage:`url('./static/image/circle/${circleArr[item-1]}')`}"
           class="box circleBox">
      </div>
      <div v-for="item in 16" :key="'line'+item"
           :style="{
            backgroundImage:`url('./static/image/line/${lineArr[item-1]}')`,
    ...
    .view {
      ...
      .box {
        ...
        &.bg {
          ...
          background: {
            image: url("../../../../../public/static/image/map.png");
        ...
        &.road {
          transform: rotateX(65deg) rotateZ(24deg) translateZ(0px);
          background: {
            image: url("../../../../../public/static/image/road.gif");
            size: 14.31rem 25.08rem;
            position: center center;
            repeat: no-repeat;
          };
        ...
        &.dnxb {
          background: {
            image: url("../../../../../public/static/image/circle/circle(0-00-00-04).png");
            size: 20rem 20rem;
            position: center center;
            repeat: no-repeat;
          };
